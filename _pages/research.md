...
Abstract: We examine the competitive effects of regional airline exits on the U.S. airline industry in 2020, using data at the airline-market-time level and leveraging the COVID-19 pandemic as a natural experiment. Our empirical analysis based on the propensity score matching and the difference-in-differences models leads to several conclusions. At the market level, when regional airlines exit, the number of flights and passengers significantly decreases, and no immediate replacements emerge. In these markets, airfare increases by roughly 4.3% but on-time performance improves dramatically, with delays decreasing by around 31.1%. On the airline market level, incumbent carriers respond by increasing flights and capacity by 12.5%. Smaller carriers, in particular, capture more market from exiting regional airlines. Overall, passengers face higher airfare but enjoy improved punctuality. Incumbent carriers adapt by expanding services, and smaller carriers thrive. These findings underscore the need for balanced competition and regulatory policies to benefit consumers in the airline industry.
